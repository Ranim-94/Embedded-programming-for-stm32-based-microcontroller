...
C_SRCS += \
../Src/main_LED_bitshift.c \
../Src/syscalls.c \
../Src/sysmem.c 

OBJS += \
./Src/main_LED_bitshift.o \
./Src/syscalls.o \
./Src/sysmem.o 

C_DEPS += \
./Src/main_LED_bitshift.d \
./Src/syscalls.d \
./Src/sysmem.d 
...
clean-Src:
	-$(RM) ./Src/main_LED_bitshift.d ./Src/main_LED_bitshift.o ./Src/syscalls.d ./Src/syscalls.o ./Src/sysmem.d ./Src/sysmem.o
